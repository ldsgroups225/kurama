/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: c39bf812a2938fcbff7fb7b9e96b589b)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		R2_LESSON_BUCKET_NAME: string;
		R2_PUBLIC_URL: string;
		POLAR_SECRET: string;
		POLAR_WEBHOOK_SECRET: string;
		VITE_SENTRY_DSN: string;
		VITE_SENTRY_ENVIRONMENT: string;
		VITE_SECURITY_INACTIVITY_DAYS: string;
		VITE_SECURITY_MAX_AUTH_ATTEMPTS: string;
		VITE_SECURITY_SESSION_TIMEOUT_HOURS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_HOST" | "DATABASE_USERNAME" | "DATABASE_PASSWORD" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "R2_ACCOUNT_ID" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_LESSON_BUCKET_NAME" | "R2_PUBLIC_URL" | "POLAR_SECRET" | "POLAR_WEBHOOK_SECRET" | "VITE_SENTRY_DSN" | "VITE_SENTRY_ENVIRONMENT" | "VITE_SECURITY_INACTIVITY_DAYS" | "VITE_SECURITY_MAX_AUTH_ATTEMPTS" | "VITE_SECURITY_SESSION_TIMEOUT_HOURS" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL">> {}
}
