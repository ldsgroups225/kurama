  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl text-center">
        ...
        `}
        >
          <Button size="lg" className="group" asChild data-get-started-button>
            <Link to="/app">
              Commencer à étudier
      ...
      >
        <div
          className={`
            relative left-[calc(50%-11rem)] aspect-1155/678 w-144.5
            -translate-x-1/2 rotate-30 bg-linear-to-tr from-primary to-secondary
            opacity-20
