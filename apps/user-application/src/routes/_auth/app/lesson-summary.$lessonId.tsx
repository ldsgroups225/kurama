      ...
      <main className="mx-auto max-w-lg space-y-6 px-4 py-6">
        ...
        >
          <div className="flex justify-center">
            <div className={`
              bg-gradient-level flex h-24 w-24 items-center justify-center
              rounded-full
            `}
            >
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2 text-center">
                  <div className={`
                    bg-success mx-auto flex h-12 w-12 items-center
                ...
                <div className="space-y-2 text-center">
                  <div className={`
                    bg-error mx-auto flex h-12 w-12 items-center justify-center
                    rounded-full
                  `}
                  >
